...
#Train Models
train_sets = ["seabirdwatch","neill","USGS","hayes","terns","penguins","pfeifer","palmyra","mckellar","monash","everglades","murres","michigan","valle","poland"]
test_sets =["palmyra"]
all_sets = []
...
all_annotations = pd.concat([train_annotations, test_annotations])
model = fit(model, all_annotations, comet_logger, "palmyra_combined")
