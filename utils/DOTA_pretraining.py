...
train_df["xmin"] = train_df[["x1","x2","x3","x4"]].apply(lambda x: x.min()+1,axis=1)
train_df["xmax"] = train_df[["x1","x2","x3","x4"]].apply(lambda x: x.max()-1,axis=1)
train_df["ymin"] = train_df[["y1","y2","y3","y4"]].apply(lambda y: y.min()+1,axis=1)
train_df["ymax"] = train_df[["y1","y2","y3","y4"]].apply(lambda y: y.max()-1,axis=1)
...
test_df["xmin"] = test_df[["x1","x2","x3","x4"]].apply(lambda x: x.min()+1,axis=1)
test_df["xmax"] = test_df[["x1","x2","x3","x4"]].apply(lambda x: x.max()-1,axis=1)
test_df["ymin"] = test_df[["y1","y2","y3","y4"]].apply(lambda y: y.min()+1,axis=1)
test_df["ymax"] = test_df[["y1","y2","y3","y4"]].apply(lambda y: y.max()-1,axis=1)
