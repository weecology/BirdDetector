...
df = pd.read_csv("/blue/ewhite/b.weinstein/generalization/crops/terns_train.csv")
...
model.config["validation"]["csv_file"] = "/blue/ewhite/b.weinstein/generalization/crops/terns_test.csv"
...
test_results = model.evaluate(csv_file="/blue/ewhite/b.weinstein/generalization/crops/terns_test.csv", root_dir="/blue/ewhite/b.weinstein/generalization/crops/", iou_threshold=0.25)
...
test_results = model.evaluate(csv_file="/blue/ewhite/b.weinstein/generalization/crops/terns_test.csv",
