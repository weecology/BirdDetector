...
df = pd.read_csv("/blue/ewhite/b.weinstein/generalization/crops/palmyra_train.csv")
...
model.config["validation"]["csv_file"] = "/blue/ewhite/b.weinstein/generalization/crops/palmyra_test.csv"
...
test_results = model.evaluate(csv_file="/blue/ewhite/b.weinstein/generalization/crops/palmyra_test.csv",
