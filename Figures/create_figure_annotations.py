...
# Figure 3
#A
shutil.copy2(src="/blue/ewhite/b.weinstein/generalization/crops/seabirds_rgb_809.png", "seabirds_rgb_809.png")
...
#B
shutil.copy2(src="/blue/ewhite/b.weinstein/generalization/crops/Islands_south_2016_Chinstrap_penguins_76.png", "Islands_south_2016_Chinstrap_penguins_76.png")
...
#C
shutil.copy2(src="/blue/ewhite/b.weinstein/generalization/crops/Dudley_projected_311.png", "Dudley_projected_311.png")
ground_truth = pd.read_csv("/blue/ewhite/b.weinstein/generalization/crops/palmyra_test.csv")
ground_truth = ground_truth[ground_truth.image_path == "Dudley_projected_311.png"]
ground_truth["geometry"] = ground_truth.apply(lambda x: geometry.box(x["xmin"],x["ymin"],x["xmax"],x["ymax"]), axis = 1)
ground_truth = gpd.GeoDataFrame(ground_truth)
...
boxes = m.predict_image(path = "/blue/ewhite/b.weinstein/generalization/crops/Dudley_projected_311.png")
boxes["geometry"] = boxes.apply(lambda x: geometry.box(x["xmin"],x["ymin"],x["xmax"],x["ymax"]), axis = 1)
boxes = gpd.GeoDataFrame(boxes)
boxes.to_file("Dudley_projected_311_predictions.shp")


#D
shutil.copy2(src="/blue/ewhite/b.weinstein/generalization/crops/SteepleJason_Hump_Nov2019_transparent_mosaic_group1---381.png", "SteepleJason_Hump_Nov2019_transparent_mosaic_group1---381.png")
